...
from kombu.asyncronous import Hub, READ, WRITE, ERR
from kombu.asyncronous.debug import callback_for, repr_flag, _rcb
from kombu.asyncronous.semaphore import DummyLock, LaxBoundedSemaphore
...
class test_Hub(Case):
    ...
    @patch('kombu.asyncronous.hub.poll')
    ...
    def test_fire_timers_raises(self):
        ...
        hub.scheduler = iter([(0, eback)])
        with patch('kombu.asyncronous.hub.logger') as logger:
